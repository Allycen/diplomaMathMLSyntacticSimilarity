...
public class IdxNode<T> {
    ...
    public boolean equals(Content content, Object obj) {
     ...
     // проверка на равенство узлов когда совпадают имена и кол-во листьев
//    public boolean equalsWithLeavesCount(Object obj) {
//        if(obj == this) 
//            return true;
//        
//        if(obj == null) 
...
//    public boolean equalsWithLabelTreeIdRepeatId(Object obj) {
//        if(obj == this) 
//            return true;
//        
//        if(obj == null) 
...
//    }
    ...
    // проверка на равенство когда все данные совпадают
